...
4. **Propose updates** — \`arcbridge_arc42\` to generate documentation update proposals
`;
...
5. **Complete phase** — if all checks pass, run \`arcbridge_manage_phases\` to validate gates and transition
`;
