...
function generateClaudeMd(config: ArcBridgeConfig): string {
  const lines: string[] = [
    ...
    "- `arcbridge_arc42` (action: propose) — propose doc updates from recent code changes",
    "",
    ...
    "- `arcbridge_manage_tasks` (action: update) — mark tasks as in-progress or done as you complete them",
