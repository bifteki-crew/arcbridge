...
function generateCopilotInstructions(config: ArcBridgeConfig): string {
  const lines: string[] = [
    ...
    "- `arcbridge_query_symbols` — Search for functions, classes, types; pass `symbol_id` for full detail",
    ...
    "- `arcbridge_arc42` (action: propose) — Generate arc42 update proposals from code changes",
