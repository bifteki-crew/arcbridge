...
// ─── Fullstack Next.js + .NET scenarios ────────────────────────────────────

const FULLSTACK_NEXTJS_DOTNET_SCENARIOS: Record<string, ScenarioList> = {
  security: [
    {
      id: "SEC-02",
      ...
      expected:
        "No API keys, tokens, or secrets are found in client-side code or hardcoded in appsettings",
      linked_code: [],
      linked_tests: [],
