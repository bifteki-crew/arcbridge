  ...
  indexing: z
    .object({
      ...
      csharp_indexer: z
        ...
        .default("auto")
        .describe(
          "C# indexer backend: 'auto' checks for global tool or dotnet CLI — uses Roslyn if found, otherwise tree-sitter. " +
          "'tree-sitter' works without .NET SDK. 'roslyn' requires global tool or .NET SDK.",
        ),
    })
    .default({}),
