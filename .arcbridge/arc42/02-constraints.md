...
Document the constraints that shape architectural decisions for arcbridge. Constraints are non-negotiable requirements from the environment — they are not chosen, they are given.
